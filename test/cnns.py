...
def getCNNs(level=1):
    ...
    if level == 1:
        if cnn['level1'] is None:
            F = CNN('/home/yhb-pc/CNN_Face_keypoint/prototxt/1_F_deploy.prototxt', '/home/yhb-pc/CNN_Face_keypoint/model/1_F/%s'%(m1))
            EN = CNN('/home/yhb-pc/CNN_Face_keypoint/prototxt/1_EN_deploy.prototxt', '/home/yhb-pc/CNN_Face_keypoint/model/1_EN/%s'%(m2))
            NM = CNN('/home/yhb-pc/CNN_Face_keypoint/prototxt/1_NM_deploy.prototxt', '/home/yhb-pc/CNN_Face_keypoint/model/1_NM/%s'%(m2))
            cnn['level1'] = [F, EN, NM]
        return cnn['level1']
    elif level == 2:
        if cnn['level2'] is None:
            cnn['level2'] = []
            for t in types:
                cnn['level2'].append(CNN('/home/yhb-pc/CNN_Face_keypoint/prototxt/2_%s_deploy.prototxt'%t, '/home/yhb-pc/CNN_Face_keypoint/model/2_%s/%s'%(t,m2)))
        return cnn['level2']
    else:
        if cnn['level3'] is None:
            cnn['level3'] = []
            for t in types:
                cnn['level3'].append(CNN('/home/yhb-pc/CNN_Face_keypoint/prototxt/3_%s_deploy.prototxt'%t, '/home/yhb-pc/CNN_Face_keypoint/model/3_%s/%s'%(t,m3)))
        return cnn['level3']

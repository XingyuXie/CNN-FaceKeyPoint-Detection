...
TXT = '/home/yhb-pc/CNN_Face_keypoint/dataset/train/testImageList.txt'
template = '''################## Summary #####################
Test Number: %d
Time Consume: %.03f s
FPS: %.03f
...
def plotError(e, name):
    ...
    fig.suptitle('%s'%name)
    fig.savefig('/home/yhb-pc/CNN_Face_keypoint/log/%s.png'%name)
...
#    level = int(sys.argv[1])
    ...
    logfile = '/home/yhb-pc/CNN_Face_keypoint/log/{0}.log'.format(nameMapper[level])
